              ...
              <SwiperSlide>
                <div className="buy-bet">
                  <div className="buy-input">
                    <h3>
                      Enter Amount <span>in $</span>
                    </h3>
                    <input type="number" value="1" />
                    <h3>
                      Amount in Matic <span>approx</span>{" "}
                    </h3>
                          ...
                          <>
                            <div className="composition" key={key}>
                              <div className="composition-top">
                                <img
                                  src={`https://test.joinclamp.com/tokens/${e.tokenName}.svg`}
                                  alt=""
                                />
                                <p>
                                  {e.tokenName} <br />{" "}
                                  <span>{e.tokenName}</span>
                                </p>
                              </div>
                  ...
                  <div className="buy-bot">
                    <div className="note">
                      <p>
                        <AiOutlineInfoCircle /> By clicking "Next", you are
                        confirming that you have read our Terms of Use and
                        Privacy Policy.{" "}
                      </p>
                    </div>
              ...
              <SwiperSlide>
                <div className="buy-bet">
                  ...
                  <div className="buy-bot">
                    <div className="note">
                      <p>
                        <AiOutlineInfoCircle /> By clicking "Buy", you are
                        confirming that you have read our Terms of Use and
                        Privacy Policy.{" "}
                      </p>
                    </div>
